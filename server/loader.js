...
export default (req, res) => {
  ...
  */
  const injectHTML = (data, { html, title, meta, body, scripts, state, styles }) => {
    ...
    (err, htmlData) => {
      ...
      /*
        Here's the core funtionality of this file. We do the following in specific order (inside-out):
          ...
          3. Inside of a Redux <StaticRouter /> (since we're on the server), given a building and context to write to
